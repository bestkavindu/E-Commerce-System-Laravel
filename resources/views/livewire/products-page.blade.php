                ...
                <div class="flex flex-wrap mb-24 -mx-3">
                    <div class="w-full pr-2 lg:w-1/4 lg:block">
                        ...
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <div>
                                <flux:heading size='md' class="mb-2 font-medium dark:text-gray-400">
                                    {{ $this->priceRange ? 'Up to LKR ' . number_format($this->priceRange) : 'Select Price Range' }}
                                </flux:heading>
                                ...
                                <div class="flex justify-between ">
                                    ...
                                    <span class="inline-block text-lg font-bold text-blue-400 ">{{'LKR ' . number_format(500000)}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
